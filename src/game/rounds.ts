...
// 5 lb-using totals (125, 145, 165, 195, 215, …) live in tier 1 so they show up
// in light rounds. 2.5 lb-using totals (140, 150, 160, …) and fractional .5s
// move into tier 2+ where the mental math gets twitchier.
const LB_TARGETS_BY_TIER: Record<1 | 2 | 3 | 4, number[]> = {
  1: [95, 115, 125, 135, 145, 155, 165, 185, 195, 205, 215, 225],
  2: [140, 150, 160, 235, 245, 255, 265, 275, 285, 295, 305, 315, 325, 335, 365, 385],
  3: [405, 425, 455, 475, 495, 525, 545, 142.5, 152.5, 167.5, 192.5, 232.5, 257.5],
  4: [585, 605, 635, 675, 705, 322.5, 367.5, 472.5, 537.5, 572.5],
}

const KG_TARGETS_BY_TIER: Record<3 | 4, number[]> = {
  3: [40, 50, 60, 70, 80, 100, 120, 52.5, 62.5, 72.5],
  4: [110, 130, 140, 160, 180, 200, 220, 102.5, 142.5, 162.5, 182.5],
}
